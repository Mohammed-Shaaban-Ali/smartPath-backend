...
router.post("/", upload_1.uploadImage.single("icon"), sectionController_controller_1.createSection);
router.get("/", sectionController_controller_1.getSections);
router.get("/:id", sectionController_controller_1.getSectionById);
router.put("/:id", upload_1.uploadImage.single("icon"), sectionController_controller_1.updateSection);
